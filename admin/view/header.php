...
<body>
    ...
    <header class="pb-4">
        <div class="bg-secondary-subtle p-5">
            ...
            <div class="ms-5">
                <button class="btn btn-primary me-2 mb-2 mb-sm-0">
                    <a href="index.php" class="text-decoration-none text-dark fw-bold">Trang chủ</a>
                </button>
                <button class="btn btn-light me-2 mb-2 mb-sm-0">
                    <a href="index.php?act=danhmuc" class="text-decoration-none text-dark fw-bold">Danh mục</a>
                </button>
                <button class="btn btn-light me-2 mb-2 mb-sm-0">
                    <a href="index.php?act=sanpham" class="text-decoration-none text-dark fw-bold">Sản phẩm</a>
                </button>
                <button class="btn btn-light me-2">
                    <a href="index.php?act=user" class="text-decoration-none text-dark fw-bold">Tài khoản</a>
                </button>
